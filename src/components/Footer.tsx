                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex flex-col space-y-2">
                            {/* LinkedIn */}
                            <a href="https://www.linkedin.com/company/aws-cloud-clubs-at-ggsipu/" className="flex items-center space-x-2 pl-3 pr-1 py-1.5 border border-gray-600 rounded-md hover:border-[#843aed] hover:bg-[#843aed]/10 transition-all duration-300 group">
                            ...
                            {/* Instagram */}
                            <a href="https://www.instagram.com/awscloudclubggsipu/" className="flex items-center space-x-2 pl-3 pr-1 py-1.5 border border-gray-600 rounded-md hover:border-[#843aed] hover:bg-[#843aed]/10 transition-all duration-300 group">
                                <svg className="w-4 h-4 text-gray-400 group-hover:text-[#843aed] transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            {/* Meetup */}
                            <a href="https://www.meetup.com/aws-cloud-club-at-ggsipu/" className="flex items-center space-x-2 pl-3 pr-1 py-1.5 border border-gray-600 rounded-md hover:border-[#843aed] hover:bg-[#843aed]/10 transition-all duration-300 group">
                                <svg className="w-4 h-4 text-gray-400 group-hover:text-[#843aed] transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="https://mail.google.com/mail/u/0/#inbox?compose=CllgCHrfScpwRBXTTqxpgmtRJbZhqwcsBqSpzqkpFtvbHGQBdrhsmjsQpPVwZlrgGPcRwwQJLrg" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 pl-3 pr-1 py-1.5 border border-gray-600 rounded-md hover:border-[#843aed] hover:bg-[#843aed]/10 transition-all duration-300 group">
                                ...
                                <span className="text-gray-300 group-hover:text-[#843aed] font-medium text-xs transition-colors duration-300">Email Us</span>
                            </a>
                        </div>
                    </div>
                </div>
