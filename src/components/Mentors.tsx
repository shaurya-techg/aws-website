...
export default function Mentors() {
  ...
  return (
    <div ref={ref} className="w-full border-y-[1px] border-gray-300 max-w-7xl mx-auto my-8 sm:my-12 lg:my-16 p-4 sm:p-6 lg:p-8 bg-gradient-to-b from-[#180235] to-[#030012] rounded-lg">
      ...
      <div className="flex flex-col lg:flex-row gap-12 sm:gap-16 lg:gap-20 justify-center items-start">
        {mentors.map((mentor, idx) => (
          <motion.div
            key={idx}
            className="flex flex-col items-center rounded-xl p-6 sm:p-8 shadow-md w-full max-w-md mx-auto hover:scale-105 transition-transform duration-300"
          ...
          >
            ...
            <div className="flex flex-col items-center bg-gradient-to-b from-[#8444E8] to-[#4349FF] p-4 rounded-lg transition-all duration-300">
              ...
              {mentor.linkedin && (
                <a href={mentor.linkedin} target="_blank" rel="noopener noreferrer" className="text-[#843aed] hover:text-[#4349ff] transition-colors duration-200">
