...
export default function Navbar() {
    ...
    // Prevent hydration mismatch by not rendering dynamic elements until client-side
    if (!isClient) {
        return (
            <div className="w-full px-10 sm:px-20 lg:px-30 fixed top-0 left-0 z-50 bg-[#030012]/95 backdrop-blur-sm opacity-100 translate-y-0">
