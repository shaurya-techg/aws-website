...
const MemberCard: React.FC<MemberCardProps> = ({ 
  ...
  return (
    ...
    >
      <div className="relative h-full bg-white/10 backdrop-blur-lg rounded-3xl p-1 border border-white/20 overflow-hidden group-hover:bg-white/20 transition-all duration-300 flex flex-col">
